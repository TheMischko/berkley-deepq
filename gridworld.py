...
def parseOptions():
    ...
    if opts.manual and (opts.agent != 'q' or opts.agent != 'q2'):
...
if __name__ == '__main__':
    ...
    if opts.agent == 'value':
        ...
        qLearnOpts = {'gamma': opts.discount,
                      ...
                      'epsilon': opts.epsilon,
                      'actionFn': actionFn}
        a = qlearningAgents.DeepQAgent(mdp, **qLearnOpts)
    else:
    ...
    if not opts.quiet:
        if opts.manual and opts.agent == None:
            ...
            if opts.agent == 'q2': displayCallback = lambda state: display.displayQValues(a, state, "CURRENT Q-VALUES")
            if opts.agent == 'deepq': displayCallback = lambda state: display.displayQValues(a, state, "CURRENT Q-VALUES")
